...
const Orders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                // Fetching all orders for the authenticated merchant
        ...
        <div className="p-8 max-w-7xl mx-auto bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {orders.map((order) => {
                    ...
                    // Shared styles for the card appearance
                    ...
                    // Extracted inner content to keep the code clean and avoid duplication
                    const CardInner = (
                        <>
                    ...
                    return (
                        <div key={order.id} className="relative group">
                            {/* Visual indicator for unpaid orders */}
                            {!isPaid && (
                            ...
                            {/* FIXED: Using conditional rendering for the wrapper element.
                                If the order is paid, it renders a <div>.
                                If the order is unpaid, it renders an <a> with a valid href.
